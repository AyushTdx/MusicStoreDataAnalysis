...
Write a query that returns the Artist id and total track count of the top 10 rock bands. */
...
WITH best_selling_artist AS (
	SELECT artist.artist_id AS artist_id, SUM(invoice_line.unit_price * invoice_line.quantity) AS total_sales
	FROM invoice_line
	JOIN track ON track.track_id = invoice_line.track_id
	JOIN album2 ON album2.album_id = track.album_id
	JOIN artist ON artist.artist_id = album2.artist_id
